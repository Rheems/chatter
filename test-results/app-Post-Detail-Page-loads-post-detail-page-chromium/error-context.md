...
- Name: app.spec.ts >> Post Detail Page >> loads post detail page
- Location: src\tests\e2e\app.spec.ts:149:7
...
Call log:
  - navigating to "http://localhost:3000/posts/1", waiting until "load"
